...
public class Customers {
	...
	// constructor used for getting the first, last, name and calling the rest of
	// the methods
	public Customers() {
		getOrder();
	}
	...
	private void getOrderDetails() {
		...
		while (!foodDetails.equalsIgnoreCase("Chicken Gyro") && !foodDetails.equalsIgnoreCase("Lamb Gyro")
				&& !foodDetails.equalsIgnoreCase("Chicken over Rice Platter")
				&& !foodDetails.equalsIgnoreCase("Lamb over Rice Platter")
				...
				&& !foodDetails.equalsIgnoreCase("Falafel Salad")
				&& !foodDetails.equalsIgnoreCase("Strawberry Cheesecake")
